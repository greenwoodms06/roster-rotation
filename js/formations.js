    ...
    byCount: {
      9: {
        ...
        formations: [
          ...
          { name: 'Shift Right', coords: {
              'P':  [50, 68], 'C':  [50, 87],
              '1B': [70, 62], '2B': [66, 48], 'SS': [52, 48], '3B': [30, 62],
              'LF': [22, 25], 'CF': [55, 15], 'RF': [82, 25] } },
        ],
      },
    },
  },
    ...
    byCount: {
      3: {
        ...
        formations: [
          ...
          { name: 'Triangle', coords: { 'G': [50, 20], 'F': [72, 55], 'C': [28, 55] } },
        ],
      },
      5: {
