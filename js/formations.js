      ...
      7: {
        ...
        formations: [
          ...
          { name: '2-1-2-1', coords: {
              ...
              'ST': [50, 16] } },
          { name: '3-2-1', coords: {
              'GK': [50, 91], 'LB': [22, 72], 'CM': [50, 76], 'RB': [78, 72],
              'LW': [30, 48], 'RW': [70, 48],
              'ST': [50, 18] } },
          { name: '2-1-3', coords: {
              'GK': [50, 91], 'LB': [25, 72], 'RB': [75, 72],
              'CM': [50, 50],
              'LW': [22, 22], 'ST': [50, 16], 'RW': [78, 22] } },
        ],
      },
      9: {
        ...
        formations: [
          ...
          { name: '2-3-3', coords: {
              ...
              'LF': [22, 22], 'CB': [50, 18], 'RF': [78, 22] } },
          { name: '3-4-1', coords: {
              'GK': [50, 91], 'LB': [22, 72], 'CB': [50, 75], 'RB': [78, 72],
              'LM': [15, 50], 'CM': [38, 52], 'RM': [62, 52], 'LF': [85, 50],
              'RF': [50, 18] } },
        ],
      },
      11: {
        ...
        formations: [
          ...
          { name: '4-4-2', coords: {
              ...
              'RW': [35, 22], 'ST': [65, 22] } },
          { name: '3-5-2', coords: {
              'GK': [50, 91], 'LCB': [25, 78], 'CM': [50, 82], 'RCB': [75, 78],
              'LB': [10, 52], 'LM': [35, 52], 'RM': [65, 52], 'RB': [90, 52], 'LW': [50, 38],
              'RW': [35, 18], 'ST': [65, 18] } },
          { name: '4-2-3-1', coords: {
              'GK': [50, 91], 'LB': [12, 72], 'LCB': [35, 75], 'RCB': [65, 75], 'RB': [88, 72],
              'LM': [35, 55], 'RM': [65, 55],
              'LW': [18, 32], 'CM': [50, 30], 'RW': [82, 32],
              'ST': [50, 16] } },
        ],
      },
    },
      ...
      7: {
        ...
        formations: [
          ...
          { name: 'Shotgun', coords: {
              ...
              'RB': [35, 62], 'TE': [65, 47] } },
          { name: 'Bunch Right', coords: {
              'QB': [50, 57], 'C': [50, 47],
              'TE': [12, 47],
              'WR1': [78, 45], 'WR2': [83, 49], 'WR3': [88, 45],
              'RB': [50, 65] } },
        ],
      },
      8: {
    ...
    byCount: {
      3: {
        ...
        formations: [
          ...
          { name: 'Stack', coords: { 'G': [50, 18], 'F': [50, 42], 'C': [50, 68] } },
        ],
      },
      5: {
        ...
        formations: [
          { name: 'Standard', coords: {
              ...
              'PF': [72, 58], 'C': [50, 68] } },
          { name: '4-Out 1-In', coords: {
              'PG': [50, 16], 'SG': [82, 38], 'SF': [18, 38],
              'PF': [78, 72], 'C': [50, 65] } },
          { name: '1-4 High', coords: {
              'PG': [50, 12],
              'SF': [18, 32], 'C': [38, 30], 'PF': [62, 30], 'SG': [82, 32] } },
        ],
      },
    },
  },
    ...
    byCount: {
      ...
      6: {
        ...
        formations: [
          ...
          { name: '1-3-1 PP', coords: {
              'G': [50, 88], 'LD': [50, 55],
              'RD': [25, 30], 'C': [50, 28], 'LW': [75, 30],
              'RW': [50, 12] } },
          { name: 'Umbrella', coords: {
              'G': [50, 88], 'LD': [25, 42], 'RD': [75, 42],
              'C': [50, 26],
              'LW': [22, 14], 'RW': [78, 14] } },
        ],
      },
    ...
    byCount: {
      6: {
        ...
        formations: [
          { name: 'Box', coords: {
              ...
              'M': [50, 48],
              'A1': [30, 22], 'A2': [70, 22] } },
          { name: '1-2-2 Diamond', coords: {
              'G': [50, 88], 'D1': [50, 72],
              'D2': [25, 50], 'M': [75, 50],
              'A1': [30, 22], 'A2': [70, 22] } },
          { name: 'Press', coords: {
              'G': [50, 88], 'D1': [25, 55], 'D2': [75, 55],
              'M': [50, 32],
              'A1': [35, 12], 'A2': [65, 12] } },
        ],
      },
      10: {
        ...
        formations: [
          ...
          { name: '1-4-1 Set', coords: {
              'G': [50, 88], 'D1': [25, 73], 'D2': [50, 78], 'D3': [75, 73],
              'A1': [50, 5],
              'A2': [25, 18], 'M1': [30, 30], 'M3': [70, 30], 'A3': [75, 18],
              'M2': [50, 12] } },
          { name: '2-3-1 Set', coords: {
              'G': [50, 88], 'D1': [25, 73], 'D2': [50, 78], 'D3': [75, 73],
              'A1': [30, 30], 'A3': [70, 30],
              'M1': [22, 22], 'A2': [50, 22], 'M3': [78, 22],
              'M2': [50, 12] } },
        ],
      },
      12: {
