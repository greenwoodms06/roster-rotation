...
const HELP_SECTIONS = [
  ...
  { title: 'Game Day', items: [
    ...
    { title: 'Constraints (optional)', desc: 'Expand the Constraints panel to fine-tune generation. <strong>Position stickiness</strong> reduces mid-game position changes. <strong>Max periods</strong> caps how many periods any player plays (hard cap). <strong>Max subs / break</strong> limits roster changes between periods (useful for large rosters); it auto-relaxes if it would force anyone past the Max Periods cap. Tap a player name to <strong>lock</strong> them to a position.' },
